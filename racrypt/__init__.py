...
class RaCryptLib(object):
    ...
    def load(self, lib_dir):
        ...
        lib_dir = path.join(lib_dir, 'racrypt')
    ...
    def create_keys(self) -> bool:
        ...
        buffer1 = create_string_buffer(32)
        buffer2 = create_string_buffer(64)
        ...
        self.public_key = buffer1.raw
        self.public_key_hex = buffer1.raw.hex()
        self.private_key = buffer2.raw
        self.private_key_hex = buffer2.raw.hex()
    ...
    def verify(self, data, pub_key, signature):
        ...
        buffer_data = create_string_buffer(92)
